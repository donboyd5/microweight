...
#**********************************************************************************************#
sum(cc_dense1$iweight_state)
sum(cc_dense1$N1_nnz)
tmp <- cc_sparse1 %>% filter(str_detect(cname, "N1_nnz"))
sum(tmp$nzcc)
cc_sparse2 %>% filter(str_detect(cname, "N1_nnz"))
...
tmp2 <- cc_sparse %>% filter(str_detect(cname, "N1_nnz"))
sum(tmp2$nzcc)

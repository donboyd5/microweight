#' Reasonably big extract from the American Community Survey (ACS).
#'
#' tibble with 100,000 person records from 20 states (AK through ME)
#' from the 2013-2017 5-year ACS.
#'
#' @format A data frame with 100,000 rows and 17 variables. The most important
